...
// 1行分のデータを取得
bool MZ1Z002::GetLine(std::vector<char>& receiveBuffer, int& number)
{
	receiveBuffer.clear();
	number = 0;
	int size = 0;
...
// コンバート
bool MZ1Z002::ConvertFile(const std::string filepath, const std::string outputFilepath)
{
	this->space = 4;
...
// 後ろに変数が続く可能性のある命令か
bool MZ1Z002::IsExistVariable(std::string command)
{
...
bool MZ1Z002::IsVariableNameChar(unsigned char byte, bool first)
{
	if(byte >= 'A' && byte <= 'Z')
	{
		return true;
...
bool MZ1Z002::IsFixedVariableNameChar(unsigned char byte, bool first)
{
	if(byte >= 'A' && byte <= 'Z')
	{
		return true;
...
// 変数を登録する、変数名を変更する
// 登録出来たらtrueを返す
bool MZ1Z002::SetVariableName(std::string& variableName, std::vector<char>& result, bool array, int number)
{
	// 空なら何もしない
...
bool MZ1Z002::IsBracketCommand(std::string command)
{
...
// (カッコの始まりを登録する
void MZ1Z002::PushBrackets(void)
{
...
std::vector<char> MZ1Z002::PreConvertLine(const std::vector<char>& buffer, int number)
{
...
bool MZ1Z002::Convert(const std::vector<char>& buffer, int number, int conditions)
{
	this->space = 4;
	Lexical lexical = { "NOP", "" };
	int phase = 1;	// 0=direct, 1=code, 2=code80, 3=codeB2
...
void MZ1Z002::ConvertSub(const std::vector<char>& buffer, Lexical& lexical, unsigned char byte, bool processedDelimiter, int number, int& subNumber)
{
	this->debugLine += Format("%s", code_80_xx[byte]);
	++ this->convertIndex;
...
void MZ1Z002::AnalyzeCommand(Lexical& lexical, int number, int& subNumber, bool delimiter)
{
...
void MZ1Z002::Delimiter(int number, int& subNumber)
{
...
std::string MZ1Z002::Nop(const Lexical& lexical, bool delimiter)
{
...
std::string MZ1Z002::Rem(const Lexical& lexical, bool delimiter)
{
...
std::string MZ1Z002::Data(const Lexical& lexical, bool delimiter, int number)
{
...
std::string MZ1Z002::DefKey(const Lexical& lexical, bool delimiter)
{
...
std::string MZ1Z002::Read(const Lexical& lexical, bool delimiter)
{
	// Readする変数リスト作成
...
void MZ1Z002::Run(const Lexical& lexical, bool delimiter, int number, int& subNumber)
{
...
std::string MZ1Z002::Print(const Lexical& lexical, bool delimiter)
{
	this->printFlag = true;
...
void MZ1Z002::EndPrint(int number, int& subNumber)
{
...
std::string MZ1Z002::For(const Lexical& lexical, bool delimiter)
{
	++ this->forStackCount;
	this->forPhase = 1;
...
std::string MZ1Z002::To(const Lexical& lexical, bool delimiter)
{
	this->forPhase = 2;
	std::string result = ", ";
...
std::string MZ1Z002::Step(const Lexical& lexical, bool delimiter)
{
	this->forPhase = 3;
	std::string result = ", ";
	result += Nop(lexical, delimiter);
...
void MZ1Z002::EndFor(int number, int& subNumber)
{
	if(this->forPhase == 1)
	{
		// エラー
...
void MZ1Z002::Next(const Lexical& lexical, bool delimiter, int number, int& subNumber)
{
	std::vector<std::string> variableList = VariableList(lexical.option);
...
std::string MZ1Z002::If(const Lexical& lexical, bool delimiter)
{
	++ this->ifStackCount;
...
void MZ1Z002::EndIf(int number, int& subNumber)
{
...
std::string MZ1Z002::Then(const Lexical& lexical, bool delimiter)
{
	std::string result = "";
	std::string option = Trim(lexical.option);
...
std::string MZ1Z002::Goto(const Lexical& lexical, bool delimiter)
{
	std::string result;
	if(this->onFlag == true)
	{
...
std::string MZ1Z002::Gosub(const Lexical& lexical, bool delimiter)
{
	std::string result;
	if(this->onFlag == true)
	{
...
std::string MZ1Z002::Return(const Lexical& lexical, bool delimiter)
{
	std::string result = "Return()";
	return result;
}

std::string MZ1Z002::Stop(const Lexical& lexical, bool delimiter)
{
	std::string result = "Stop()";
	return result;
}

std::string MZ1Z002::End(const Lexical& lexical, bool delimiter)
{
	std::string result = "End()";
	return result;
}

std::string MZ1Z002::On(const Lexical& lexical, bool delimiter)
{
	this->onFlag = true;
...
std::string MZ1Z002::Poke(const Lexical& lexical, bool delimiter)
{
...
void MZ1Z002::Dim(const Lexical& lexical, bool delimiter, int number, int& subNumber)
{
...
std::string MZ1Z002::DefFn(const Lexical& lexical, bool delimiter)
{
...
void MZ1Z002::EndDefFn(int number, int& subNumber)
{
	this->result += "; };";
	this->grobal.push_back(this->result);
	this->result = "";
...
void MZ1Z002::Input(const Lexical& lexical, bool delimiter, int number, int& subNumber)
{
	std::string option = Trim(lexical.option);
...
std::string MZ1Z002::Restore(const Lexical& lexical, bool delimiter)
{
	std::string result;
...
std::string MZ1Z002::Clr(const Lexical& lexical, bool delimiter)
{
	std::string result = "Clr()";
	return result;
}

std::string MZ1Z002::Music(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
...
std::string MZ1Z002::Tempo(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
void MZ1Z002::CloseBracket(int number, int& subNumber)
{
	this->result += ");";
	this->program[Number(number, subNumber)] = this->result;
	++ subNumber;
...
std::string MZ1Z002::Usr(const Lexical& lexical, bool delimiter)
{
//	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Wopen(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Ropen(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Close(const Lexical& lexical, bool delimiter)
{
	std::string result = "Close()";
	return result;
}

std::string MZ1Z002::Mon(const Lexical& lexical, bool delimiter)
{
	std::string result = "Mon()";
	return result;
}

std::string MZ1Z002::Limit(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Cont(const Lexical& lexical, bool delimiter)
{
	std::string result = "Cont()";
	return result;
}

std::string MZ1Z002::Get(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = Trim(lexical.option);
...
std::string MZ1Z002::Inp(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Out(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Cursor(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Set(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
...
std::string MZ1Z002::Reset(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	this->addColorFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Line(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
...
std::string MZ1Z002::Bline(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	this->closeBracesFlag = true;
	this->addColorFlag = true;
...
void MZ1Z002::Console(const Lexical& lexical, bool delimiter, int number, int& subNumber)
{
	std::string option = Trim(lexical.option);
	int phase = 0;
	std::string command;
...
void MZ1Z002::Graph(const Lexical& lexical, bool delimiter, int number, int& subNumber)
{
	std::string command;
	std::string page;
...
std::string MZ1Z002::Position(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Pattern(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	this->patternFlag = false;
	this->patternSeparatorCount = 0;
...
std::string MZ1Z002::Auto(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Image(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
	std::string result = "Image(" + option;
...
std::string MZ1Z002::Copy(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Page(const Lexical& lexical, bool delimiter)
{
	this->closeBracketFlag = true;
	std::string option = FixOptionNumber(lexical.option);
...
std::string MZ1Z002::Boot(const Lexical& lexical, bool delimiter)
{
	std::string result = "Boot()";
	return result;
}

std::string MZ1Z002::Klist(const Lexical& lexical, bool delimiter)
{
	std::string result = "Klist()";
	return result;
}

std::string MZ1Z002::Change(const Lexical& lexical, bool delimiter)
{
	std::string result = "Change()";
	return result;
}

std::string MZ1Z002::Rew(const Lexical& lexical, bool delimiter)
{
	std::string result = "Rew()";
	return result;
}

std::string MZ1Z002::Fast(const Lexical& lexical, bool delimiter)
{
	std::string result = "Fast()";
	return result;
}

std::string MZ1Z002::BasicFunction(const Lexical& lexical, bool delimiter)
{
...
std::string MZ1Z002::BasicStringFunction(const Lexical& lexical, bool delimiter)
{
	std::string functionName = lexical.command;
	std::transform(functionName.begin(), functionName.end(), functionName.begin(), tolower);
	std::transform(functionName.begin(), functionName.begin() + 1, functionName.begin(), toupper);
...
std::string MZ1Z002::BasicSign(const Lexical& lexical, bool delimiter)
{
...
std::string MZ1Z002::Pi(const Lexical& lexical, bool delimiter)
{
	std::string result = "Pi()" + FixOptionNumber(lexical.option);
	return result;
}

std::string MZ1Z002::Pos(const Lexical& lexical, bool delimiter)
{
...
std::string MZ1Z002::Color(const Lexical& lexical, bool delimiter)
{
	this->wMode = 0;
	this->closeBracketFlag = true;
	this->addColorFlag = true;
...
std::string MZ1Z002::CColor(const Lexical& lexical, bool delimiter)
{
	this->wMode = 0;
	this->closeBracketFlag = true;
...
std::string MZ1Z002::Circle(const Lexical& lexical, bool delimiter)
{
	this->wMode = 0;
	this->closeBracketFlag = true;
	this->addColorFlag = true;
...
std::string MZ1Z002::Box(const Lexical& lexical, bool delimiter)
{
	this->wMode = 0;
	this->closeBracketFlag = true;
	this->addColorFlag = true;
...
std::string MZ1Z002::Paint(const Lexical& lexical, bool delimiter)
{
	this->wMode = 0;
	this->closeBracketFlag = true;
	this->addColorFlag = true;
...
std::vector<std::string> MZ1Z002::SpritText(std::string text, std::string separator)
{
	int bracketsCount = 0;
...
std::string MZ1Z002::FixCcolorOption(std::string option)
{
...
std::string MZ1Z002::FixColorOption(std::string option, bool colorCommand)
{
	int bracketsCount = 0;
	bool quotation = false;
...
bool MZ1Z002::CheckEncode(unsigned char byte)
{
	if(byte < 0x20)
	{
		return true;
...
bool MZ1Z002::CheckEncodeAfter(unsigned char byte)
{
	if(byte >= 'A' && byte <= 'F')
	{
		return true;
...
std::string MZ1Z002::Encode(std::string text)
{
...
std::string MZ1Z002::Number(int number, int subNumber)
{
	return Format("%05d_%02d", number, subNumber);
}

std::string MZ1Z002::Number(std::string number)
{
	int intNumber = atoi(number.c_str());
	return Number(intNumber, 1);
}

std::string MZ1Z002::NumberList(std::string number)
{
...
bool MZ1Z002::CheckReserved(std::string text)
{
...
std::string MZ1Z002::ReplaceAll(const std::string& text, const std::string& target, const std::string& replacement)
{
...
bool MZ1Z002::CheckBasicFunction(const std::string& text)
{
...
bool MZ1Z002::CheckBasicStringFunction(const std::string& text)
{
...
// 不等号かどうか
bool MZ1Z002::CheckBasicSign(const std::string& text)
{
...
// データを文字列のarrayに変換する
std::string MZ1Z002::ParseData(const std::string& data)
{
...
// 文字列変数名を変更する
// A$ => strA
std::string MZ1Z002::ChangeVariableArrayName(std::string variableName)
{
...
// 文字列変数名を変更する
// A$ => strA
std::string MZ1Z002::ChangeStringVariableName(std::string variableName, bool array)
{
	std::string prefix = "";
...
// 文字列変数名($付き)かどうか
bool MZ1Z002::IsStringVariableName(std::string variableName)
{
	size_t dollarPos = variableName.find_last_of('$');
	if(dollarPos == 0)
	{
...
// 文字列変数名(str付き)かどうか
bool MZ1Z002::IsStringFixedVariableName(std::string variableName)
{
...
// 文字列からスペースを削除する
std::string MZ1Z002::EraseSpace(const std::string& text)
{
	std::string result = "";
	bool quotation = false;
	for(size_t i = 0; i < text.size(); ++ i)
...
// 前後のスペースを削除する
std::string MZ1Z002::Trim(const std::string& text, const char* trimCharacterList)
{
	std::string result;
...
// ,で区切られた変数リストを取得する
std::vector<std::string> MZ1Z002::VariableList(const std::string& text)
{
	std::string separator = ",";
	size_t separatorLength = separator.length();
	size_t offset = 0;
...
std::vector<std::string> MZ1Z002::DimVariableList(const std::string& text)
{
...
std::string MZ1Z002::DeleteQuotationString(std::string& text)
{
	std::string result = "";
	bool quotation = false;
	for(size_t i = 0; i < text.size(); ++ i)
...
void MZ1Z002::ReplaceNumber(void)
{
	// 次の命令の行番号と次の行番号を抽出
...
std::string MZ1Z002::ReplaceAll(std::string &replacedStr, std::string from, std::string to)
{
...
// 変数リストに含まれるかどうか
bool MZ1Z002::FindVariableList(std::string variableName)
{
	for(size_t i = 0; i < this->variableList.size(); ++ i)
	{
		if(this->variableList[i] == variableName)
...
bool MZ1Z002::FindDefFnFuncList(std::string variableName)
{
...
// オプションを修正する
std::string MZ1Z002::FixOption(std::string sourceCommand, std::string sourceOption, bool delimiter)
{
...
// Print文のセミコロンを+に変換する
std::string MZ1Z002::FixPrintOption(std::string sourceOption, bool delimiter, bool commaToPlus)
{
	std::string result;
...
std::string MZ1Z002::FixCircleOption(std::string sourceOption)
{
	std::string result;
	std::string option = FixOptionNumber(sourceOption);
...
std::string MZ1Z002::FixOptionNumber(std::string sourceOption)
{
	std::string result;
	std::string option = Trim(sourceOption);
	int phase = 0; // 0=nop, 1=direct
...
void MZ1Z002::DebugLog(std::string text)
{
	FileData file;
